...
class Student():
    ...
    def __init__(self, name, number, grade, detail, email = None):
        # 인스턴스 변수
        self._name = name
        self._number = number
        self._grade = grade
    ...
    def detail_info(self):
        ...
        print('Student Detail Info : {} {} {}'.format(self._name, self._email,self._detail))
...
studt2 = Student('Jang', 4, 1, {'gender' : 'Female', 'score1': 85, 'score2':74},'stu2@naver.com')
